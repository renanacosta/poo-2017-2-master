class Main {
  public static void main(String[] args) {
    ...
    // Conta [C]orrente
    Conta c1 = new Conta("22288833322", 'C');
    ...
    // precisa depósito inicial
    System.out.println(banco.abreConta(c1, 200) == true);
    ...
    System.out.println(c1.saque(200) == false);
    System.out.println(c1.saldo() == 190);
    System.out.println(c1.saldoDisponivelSaque() == 190);
    ...
    // CC máximo 1000 saque
    System.out.println(c1.saque(1001) == false);
    // CC máximo 1000 dep cheque
    System.out.println(c1.depositoCheque(1001) == false);
    System.out.println(c1.saldo() == 5000);
    System.out.println(c1.saldoDisponivelSaque() == 5000);
    System.out.println(c1.saque(1000) == true);
    System.out.println(c1.depositoCheque(900) == false);
    System.out.println(c1.saldo() == 4900);
    System.out.println(c1.saldoDisponivelSaque() == 4900);

    // Conta [E]special
    Conta c2 = new Conta("33344455533", 'E', 700);
    ...
    // Especial tem tudo no dobro da Corrente
    System.out.println(c2.depositoCheque(2000) == true);
    ...
    // Conta [P]oupança
    Conta c3 = new Conta("22233399944", 'P');
    ...
    System.out.println(c3.deposito(600) == true);
    ...
    System.out.println(c1.saldo() == 4865);
    System.out.println(c1.saldoDisponivelSaque() == 4865);
    ...
    System.out.println(c2.saldo() == -235);
    System.out.println(c2.limite() == 700);
    System.out.println(c2.limiteUsado() == 235);
    System.out.println(c2.saldoDisponivelSaque() == 465);
