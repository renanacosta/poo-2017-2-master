class Main {
  public static void main(String[] args) {
	...
	// para modificação
	// mas abertas a extensão
	// https://pt.wikipedia.org/wiki/Princ%C3%ADpio_aberto/fechado  

    Banco banco = new Banco();
    // Conta c1 = new Conta("22288833322", 'C');
    ContaCorrente c1 = 
    		new ContaCorrente("22288833322");
    ...
    ContaEspecial c2 = 
    		new ContaEspecial("33344455533", 700); // [E]special
    ...
    ContaPoupanca c3 = 
    		new ContaPoupanca("22233399944"); // [P]oupança
